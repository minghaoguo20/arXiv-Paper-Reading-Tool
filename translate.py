...
Usage:
    python translate.py <paper_path_or_arxiv>

Examples:
    python translate.py tex/arXiv-2511.05271v4           # Local directory
    python translate.py tex/arXiv-2402.01030v4.tar.gz   # Local archive
    python translate.py 2307.16789                       # arXiv ID (auto-download)
    python translate.py https://arxiv.org/abs/2307.16789 # arXiv URL (auto-download)
    python translate.py https://arxiv.org/pdf/2307.16789 # arXiv URL (auto-download)

Supports:
    - Directory with LaTeX source files
    - .tar.gz archive (auto-extracts)
    - arXiv ID (e.g., 2307.16789, 2307.16789v2)
    - arXiv URL (abs, pdf, src, html - any format)
